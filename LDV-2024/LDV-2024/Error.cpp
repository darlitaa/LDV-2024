...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] = {
		...
		ERROR_ENTRY(105, "Ошибка слишком большой размер таблицы лексем/идентификаторов"), 
		ERROR_ENTRY(106, "Размер таблицы  лексем/идентификаторов привысел максимальный возможный"), ERROR_ENTRY_NODEF(107),
		...
		ERROR_ENTRY(606, "Синтаксическая ошибка: Неверная структура условия"), ERROR_ENTRY_NODEF(608),
